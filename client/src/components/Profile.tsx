    ...
    if (imageUrl) {
      try {
        ...
        reader.onloadend = function () {
          ...
          doc.text(
            `Rôle: ${user.publicMetadata.role || "Non défini"}`,
            10,
            yPosition + 20
          );
          ...
          doc.text(
            `Genre: ${user.publicMetadata.gender || "Non défini"}`,
            10,
            yPosition + 30
          );
          ...
          doc.text(
            `Date de naissance: ${user.publicMetadata.dob || "Non défini"}`,
            10,
            yPosition + 40
          );
  ...
  return (
    <>
      ...
      <div className="p-4 ml-14 mt-5 dark:bg-gray-600 ">
        {/* Employee Details */}
        <div
          className={`p-4 border-2 bg-white/45 ${
        ...
        >
              ...
              <div className="relative overflow-x-auto">
                ...
                <table className="text-sm text-left hidden lg:block sm:block md:block ">
                  <thead className="text-xs   text-gray-500 uppercase bg-transparent">
                    <tr>
                      <td scope="col" className="px-6 py-3 text-gray-400 ">
                        Role
                      </td>
                      <td scope="col" className="px-6 py-3 text-gray-400">
                        Phone Number
                  ...
                  <tbody>
                    <tr className="bg-transparent text-textColor dark:text-white">
                      <th className="px-6 py-4 font-md">
                        {metadata.role ?? "Non spécifié"}
                      </th>
                      <th className="px-6 py-4 font-md">
                        {metadata.phonenumber ?? "Non spécifiée"}
                      </th>
                      <th className="px-6 py-4 font-md">
                ...
                <table className=" text-sm text-left hidden max-sm:block    ">
                  ...
                  <tbody className="dark:text-white">
                    <tr className="text-xs  text-gray-500 dark:text-white uppercas bg-transparent">
                      ...
                      <td className="text-black font-bold text-sm dark:text-white">
                        {metadata.role ?? "Non spécifié"}
                      </td>
                    </tr>
                    <tr className="text-xs  text-gray-500  uppercas bg-transparent">
                      <th className="px-6 py-4 font-md text-gray-400">
                        PHONE NUMBER
                      </th>
                      <td className="text-black font-bold text-sm dark:text-white">
                        {metadata.phonenumber ?? "Non spécifiée"}
              ...
              <div className="flex flex-col  p-3">
                <div className="mb-4">
                  <div className="rounded-full p-2 bg-green-200 dark:bg-gray-600 flex items-center justify-center ">
                    <p className="text-green-400 text-xs font-extrabold dark:text-white">
                      On Time
                    </p>
                  </div>
                </div>
          ...
          <div className="flex flex-col p-3 gap-2 font-poppis  rounded bg-slate-100 h-48 dark:bg-gray-800 mb-4">
            ...
            <div className="flex flex-col gap-3  font-poppis  ">
              ...
              <p className="px-6 font-bold dark:text-white">
