        ...
        {/* icon Dashboard */}
         ...
         {/* profil users */}
            ...
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span onClick={()=>HandlesTab(2)} className={`${Tab===2 ? 'text-blue-600 font-bold':'text-gray-900'} ms-[1.29rem] whitespace-nowrap dark:text-white  `} >Profile</span>
         ...
         <li>
          ...
          <Link to='/Notifications' >
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <IoNotificationsOutline  className={`flex-shrink-0 w-5 h-5 ${Tab ===4 ? 'text-blue-600 font-bold':'text-gray-500'} group-hover:text-gray-900 dark:group-hover:text-white`}/>
...
<div className="p-4 ml-14 mt-5 dark:bg-gray-600   ">
   <div  className={`p-4 border-2 bg-white dark:bg-gray-600 ${isSidebarOpen ? 'translate-x-0':'14'} transition-transform  border-gray-200  rounded-lg dark:border-gray-700 mt-10`}>
        {/* Alerts */}
